...
public class ControlPanel extends JPanel {
    ...
    int x = 15;
    public ControlPanel() {
        setPreferredSize(new Dimension(600, BattleshipPanel.HEIGHT));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (count == 0) {
                if (BattleshipPanel.numOfShipsFound == 4) {
                    resultMessage.setText("You won! it only took you "+ x + " guesses to win");
            ...
            if (BattleshipPanel.numOfShipsFound == 4) {
                button.setEnabled(false);
                resultMessage.setText("You won! it only took you "+ count + " guesses to win");
            }
        }
    }
    public int getCount(){
    ...
    private JPanel resultPanel() {
        ...
        resultMessage.setFont(resultMessage.getFont().deriveFont(12f));
